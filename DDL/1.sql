...
-- For more information about object locking, including a summary of what this script does, see http://www.red-gate.com/SOC4/object-locking
        ...
        IF EXISTS (SELECT 1
            ...
            BEGIN
                ...
                SET @message = @NewLine
                                ...
                                + @NewLine
                                + 'For more information, see http://www.red-gate.com/SOC4/object-locking' + @NewLine
