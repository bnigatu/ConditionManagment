CREATE TABLE [dbo].[INVESTOR_CONDITION_STATUS]
(
...
GO
ALTER TABLE [dbo].[INVESTOR_CONDITION_STATUS] ADD CONSTRAINT [pk__investor_conditi] PRIMARY KEY CLUSTERED  ([INVESTOR_CONDITION_STATUS_KEY]) ON [PRIMARY]
GO
