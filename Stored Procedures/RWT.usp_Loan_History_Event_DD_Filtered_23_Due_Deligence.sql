...
CREATE PROCEDURE [RWT].[usp_Loan_History_Event_DD_Filtered_23_Due_Deligence]

(
	@typeBucket varchar(5)
)
as
-- *** Kanti : Per the changes requested a new version of the procedure is created
-- ** These status are no more considered termincal status 'Purchase Requested', 'DD Review','Full Review','Pre-close Review','Registration','RWT Review','Seller Review'
-- 2/14/13
...
GO
GRANT EXECUTE ON  [RWT].[usp_Loan_History_Event_DD_Filtered_23_Due_Deligence] TO [report_user]
GO
